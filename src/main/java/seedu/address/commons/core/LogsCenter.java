...
public class LogsCenter {
    ...
    private static Logger
            baseLogger; // to be used as the parent of all other loggers created by this class.
    ...
    /**
     * Creates a logger with the given name prefixed by the {@code baseLogger}'s name so that the
     * created logger becomes a descendant of the {@code baseLogger}. Furthermore, the returned
     * logger will have the same log handlers as the {@code baseLogger}.
     */
    public static Logger getLogger(String name) {
        // Java organizes loggers into a hierarchy based on their names (using '.' as a separator,
        // similar to how Java
        // packages form a hierarchy). Furthermore, loggers without a level inherit the level of
        // their parent logger.
        // By prefixing names of all loggers with baseLogger's name + ".", we make the baseLogger
        // the parent of all
        // loggers. This allows us to change the level of all loggers simply by changing the
        // baseLogger level.
    ...
    private static void setBaseLogger() {
        ...
        // Level.ALL is used as the level for the handlers because the baseLogger filters the log
        // messages by level
